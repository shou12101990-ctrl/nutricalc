...
class AppState {
  ...
  static const List<String> _defaultAdoptedNames = [
    // ── EN（灰色行のみ: F2α/セルティ/メイン/へパンED/ペプチーノ/ペプタメンAF/
    //         プルモケア/ラコールNF/ツインライン/エンシュアリキッド/エレンタール/イノラス は除外） ──
    'テルミール2.0α', 'グルセルナREX', 'メイバランス', 'リーナレンMP',
    'ヘパス', 'ハイネゼリー', 'レナウェル３', 'ペプタメンスタンダード',
    'ハイネイーゲル', 'ラコールNF 半固形', 'エンテミール', 'エネーボ', 'アミノレバン',
    // ── EN補助（灰色行: GFO/オルニュート/一挙千菜。REF P1/サンファイバー/ブイ・クレスゼリー は除外） ──
    'GFO', 'オルニュート', '一挙千菜',
