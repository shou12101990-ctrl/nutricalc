...
class AppState {
  ...
  static const List<String> _defaultAdoptedNames = [
    // ── EN（セルティ以外すべて） ──
    'F2α', 'テルミール2.0α', 'グルセルナREX', 'メイバランス', 'メイン',
    'リーナレンMP', 'ヘパス', 'へパンED', 'ハイネゼリー', 'ペプチーノ',
    'レナウェル３', 'ペプタメンAF', 'ペプタメンスタンダード', 'プルモケア',
    'ハイネイーゲル', 'ラコールNF', 'ラコールNF 半固形', 'ツインライン',
    'エンテミール', 'エンシュアリキッド', 'エネーボ', 'エレンタール',
    'アミノレバン', 'イノラス',
    // ── EN補助（すべて） ──
